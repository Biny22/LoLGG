...
data class ChampionsDTO(val type : String, val format : String, val version: String, val data : List<ChampionDTO>) : Serializable
...
data class ChampionDTO(val version : String, val id : String, val key : String, val name : String, val title : String, val blurb : String, val info : ChampionInfoDTO, val image : ChampionImageDTO,
                       val tags : List<String>, val partype : String, val stats : ChampionStatsDTO) : Serializable

data class ChampionInfoDTO(val attack : Int, val defense : Int, val magic : Int, val difficulty : Int) : Serializable

data class ChampionImageDTO(val full : String, val sprite : String, val group : String, val x : Int, val y : Int, val w : Int, val h : Int) : Serializable
...
data class ChampionStatsDTO(val hp : String, val hpperlevel: String, val mp : String, val mpperlevel : String, val movespeed : String, val armor : String, val armorperlevel : String,
                            ...
                            val attackspeedperlevel : String, val attackspeed : String) : Serializable